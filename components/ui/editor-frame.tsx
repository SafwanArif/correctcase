...
export function EditorFrame({
    ...
    return (
        ...
        >
            ...
            >
                {/* Left Slot */}
                <div className="flex-1 flex items-center justify-start gap-2">{headerLeft}</div>

                {/* Center Slot */}
                <div className="flex items-center gap-1">{headerCenter}</div>
            ...
            <div
                className={cn(
                    ...
                    isCompact ? "h-0 opacity-0" : "h-8 bg-transparent"
                )}
            >
                {/* Left Slot */}
