        ...
        <div className="flex items-center justify-between p-4 border-b border-border-subtle bg-canvas/50">
            ...
            <div className="flex items-center gap-2">
                <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-muted hover:text-body bg-transparent hover:bg-elevated rounded-md transition-colors"
                >
