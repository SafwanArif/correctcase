            ...
            <div className="flex-1 relative group bg-focus transition-colors duration-300">
                ...
                <div className="absolute top-0 right-6 z-10">
                    <button
                        ...
                        className={cn(
                            "flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-b-md transition-all duration-200 backdrop-blur-sm opacity-35 group-hover:opacity-50 group-focus-within:opacity-50 hover:!opacity-100",
                            isCopied
