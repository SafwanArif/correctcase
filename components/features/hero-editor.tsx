                ...
                <textarea
                    ...
                    className={cn(
                        ...
                        isCompact
                            ...
                            : "px-6 py-4 group-hover:pt-9 group-hover:pb-9 group-focus-within:pt-9 group-focus-within:pb-9 text-lg leading-relaxed placeholder:text-muted h-auto min-h-[3rem] group-hover:min-h-[6rem] group-focus-within:min-h-[6rem]"
                    )}
                    spellCheck={false}
                    rows={1}
                />
