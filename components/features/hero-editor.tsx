...
export function HeroEditor({ defaultTools }: HeroEditorProps) {
    ...
    return (
        <div className="flex flex-col flex-1 w-full bg-transparent relative transition-colors duration-300 select-none">
            ...
            <div className="flex-1 relative group bg-black/5 dark:bg-black/20 transition-colors duration-300">
                <textarea
                    ref={textareaRef}
                    value={text}
            ...
            <div className="relative h-10 border-t border-border-subtle bg-black/5 dark:bg-black/30 backdrop-blur-sm px-6 flex items-center justify-between select-none">
