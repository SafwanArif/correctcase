        ...
        sections: [
            {
                ...
                content: "In standard US Title Case, you must capitalize the first and last word of the title, regardless of their part of speech. Additionally, capitalize all nouns, pronouns, verbs, adjectives, and adverbs. This includes short verbs like 'Is', 'Are', and 'Be'."
            },
            {
                h3: "Handling Function Words (Prepositions & Conjunctions)",
                content: "The most common error in Title Case is incorrectly capitalizing short prepositions (e.g., 'in', 'on', 'at') and coordinating conjunctions (e.g., 'and', 'but', 'for'). Our tool automatically detects these based on your selected style guide (Chicago vs. AP) and keeps them lowercase unless they are the first or last word."
            },
            {
                h3: "The 'iTunes' and 'eBay' Exception",
                content: "Modern brand names often defy standard grammar rules. Words like 'iPhone', 'eBay', and 'iTunes' start with a lowercase letter even when they appear at the start of a sentence in some contexts. CorrectCase preserves these brand-specific casing rules to ensure your text looks professional and technically accurate."
            }
        ],
        faq: [
            {
        ...
        sections: [
            {
                ...
                content: "Sentence case is easier to read than Title Case because the shape of the words is more distinctive. It also avoids the ambiguity of deciding which words are 'major' or 'minor'. This style is mandatory for most modern UI design systems and British digital content."
            },
            {
                h3: "Proper Nouns in British English",
                content: "While sentence case implies lowercase, you must retain capitalization for Proper Nouns. This includes names (London, John), days (Monday), months (January), and brands (Microsoft). Our US/UK converter intelligently detects these entities and prevents them from being lowercased."
            }
        ],
        faq: [
            {
        ...
        sections: [
            {
                ...
                content: "When you copy text from a PDF or a narrow column, words are often split with a hyphen/newline. Pasting this into a document leaves ugly broken words (e.g., 'bro- ken'). Our Smart Unhyphenator reconnects these words while analyzing the context to preserve actual compound words."
            }
        ],
        faq: [
            {
